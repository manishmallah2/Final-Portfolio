document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- SKILLS DATA ---
     ...
     // Data & Analytics
         ...
         { name: "Looker Studio", icon: "fas fa-chart-line" },
         { name: "SSRS", icon: "fas fa-file-alt" },
         { name: "Data Modelling", icon: "fas fa-project-diagram" },
         { name: "DAX Query", icon: "fas fa-percentage" },
         { name: "Power Query", icon: "fas fa-filter" },
         { name: "Big Data", icon: "fas fa-layer-group" },
  ...
  // Programming & ML
         ...
         { name: "Statistics", icon: "fas fa-calculator" },
  ...
  { name: "AppScript", icon: "fas fa-code" },

  // Tools
  { name: "VS Code", icon: "fas fa-code" },
  { name: "Jupyter", icon: "fas fa-book" },
  { name: "GitHub", icon: "fab fa-github" },
  { name: "Fabric", icon: "fas fa-cubes" },

  // Documentation
  { name: "BRD", icon: "fas fa-file-contract" },
  { name: "SOP", icon: "fas fa-file-alt" },
  { name: "SRD", icon: "fas fa-file-signature" },
  { name: "UAT", icon: "fas fa-tasks" },
  { name: "Email Automation", icon: "fas fa-envelope-open-text" }
];
